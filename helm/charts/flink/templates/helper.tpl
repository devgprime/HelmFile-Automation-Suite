...
This is a generic collection of helpers.
 ...
 - helper.serviceType: returns what type of service to use if you're using ingress or not.
 - helper.resources: returns a resources definition based on .requests and .limits passed to it.
 - helper.prestop: returns a preStop hook definition for a simple sleep
*/}}
